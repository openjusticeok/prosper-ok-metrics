...
charge_predictions <- read_csv(here("data/charge_predictions.csv")) |>
  distinct()
...
# saving for SQ780
write_csv(data_clean, here("data/data_clean_2001_2022.csv"))
write_csv(d, here("data/drug_charges_2001_2022.csv"))
```
...
# saving for SQ780
write_csv(parties, here("data/parties_2001_2022.csv"))
```
...
# saving for SQ780
write_csv(parties_clean, here("data/parties_convictions_2001_2022.csv"))
...
Next, we'll repeat this same analysis with marijuana-specific charges removed, as they would be excluded from HB 2153:
