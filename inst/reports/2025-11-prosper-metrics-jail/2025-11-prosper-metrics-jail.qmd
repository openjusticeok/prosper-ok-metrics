...
if (!is.null(jail_figures$overview_metrics_table)) {
  jail_figures$overview_metrics_table
} else {
...
#| include: params$audience %in% c("internal")
#| eval: params$audience %in% c("internal")
if (!is.null(jail_figures$booking_latest_table)) {
  jail_figures$booking_latest_table
}

if (!is.null(jail_figures$booking_annual_table)) {
...
if (!is.null(jail_figures$release_counts_table)) {
  jail_figures$release_counts_table
} else {
  invisible()
}
```
...
if (!is.null(jail_figures$release_counts)) {
...
if (!is.null(jail_figures$release_shares_table)) {
...
if (!is.null(jail_figures$release_share)) {
...
if (!is.null(jail_figures$county_comparison_table)) {
